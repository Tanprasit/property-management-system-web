...
@section('content')
<div class="row">
    <h1 class="page-header">Edit Key</h1>
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form class="form-horizontal" method="POST" action="{{ URL::route('keys.update', [$key->id]) }}">
                {{ method_field('PUT') }}
                {!! csrf_field() !!}
                ...
                <div class="form-group has-feedback">
                    ...
                    <div class="col-lg-6 input-container">
                        <input id="pin" type="text" name="pin" class="form-control" value="{{ $key->pin }}">
                        <span class="glyphicon glyphicon-ok form-control-feedback hidden" aria-hidden="true"></span>
                        <span class="glyphicon glyphicon-remove form-control-feedback hidden" aria-hidden="true"></span>
                    </div>
                </div>
                ...
                <div class="form-group has-feedback">
                    ...
                    <div class="col-lg-6 input-container" id='datetimepicker1'>
                        <div class="input-group date form_datetime">
                            <input id="taken-at" type="text" name="taken_at" class="form-control" size="16" value="{{ $key->taken_at }}">
                ...
                <div class="form-group has-feedback">
                    ...
                    <div class="col-lg-6 input-container" id='datetimepicker2'>
                       <div class="input-group date form_datetime">
                           <input id="returned-at" type="text" name="returned_at" class="form-control" size="16" value="{{ $key->returned_at }}">
                           <span class="input-group-addon">
                               <span class="glyphicon glyphicon-calendar"></span>
                           </span>
                       </div>
...
@section('scripts')
<script type="text/javascript" src="/scripts/validation/keys/edit.js"></script>
